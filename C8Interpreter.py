        ...
        match self.opcode & 0xF000:
            ...
            case 0x0000:
                if self.opcode == 0x00E0:
                    ...
                    print(f"Unknown opcode: {self.opcode:04X}")
                    return False
            ...
            case 0x7000:
                ...
                self.V[x] = (self.V[x] + (self.opcode & 0x00FF)) & 255
            ...
            case 0xC000:
                ...
                self.V[(self.opcode & 0x0F00) >> 8] = (
                    randint(0, 255) & self.opcode & 0x00FF
                )
            ...
            case 0xE000:
                ...
                match self.opcode & 0x00FF:
                    ...
                    case 0x009E:
                        ...
                        if self.keys[self.V[(self.opcode & 0x0F00) >> 8]]:
                            self.pc += 2

                    case 0x00A1:
                        # opcode 0xEXA1
                        # skip next instruction if key with value VX is not pressed
                        if not self.keys[self.V[(self.opcode & 0x0F00) >> 8]]:
                            self.pc += 2
